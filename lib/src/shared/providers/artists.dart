...
class ArtistsProvider {
  ...
  List<Artist> get artists => const [
        Artist(
          ...
          news: [
            News(
              title: 'Jessie Morrison a 26-stop cross country tour for the first time in 6 years.',
        ...
        Artist(
          ...
          news: [
            News(
              title: 'Jon James is excited for the release of his sixth album "Falling For You"',
