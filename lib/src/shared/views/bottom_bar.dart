...
class _BottomBar extends StatelessWidget {
  ...
  double get songProgress => switch ((progress, song)) {
        (Duration progress, Song song) => progress.inMilliseconds / song.length.inMilliseconds,
        _ => 0,
      };
          ...
          children: [
            ...
            Expanded(
              child: Slider(
                ...
                divisions: 100,
                onChanged: (newValue) =>
                    BlocProvider.of<PlaybackBloc>(context).add(PlaybackEvent.setVolume(newValue)),
                activeColor: Theme.of(context).colorScheme.onTertiaryContainer,
                inactiveColor: Theme.of(context).colorScheme.onSurface,
              ),
            ),
...
class _FullScreenPlayerState extends State<_FullScreenPlayer> {
  ...
  Widget buildPlayer(BuildContext context, PlaybackState state, BoxConstraints dimens) {
    final bloc = BlocProvider.of<PlaybackBloc>(context);
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          right: 20,
          child: IconButton(
            color: song != null ? context.colors.onSurface : context.colors.onSurface,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      song.artist.name,
                      style: context.labelSmall!
                          .copyWith(fontSize: 20, color: context.colors.onSurface.withOpacity(0.8)),
                      overflow: TextOverflow.clip,
                    ),
                  ],
                ),
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          left: 20,
          child: IconButton(
            color: current?.song != null ? context.colors.onSurface : context.colors.onSurface,
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: context.labelSmall!.copyWith(
                            fontSize: 12, color: context.colors.onSurface.withOpacity(0.8)),
                        overflow: TextOverflow.clip,
                      ),
                    ],
                  ),
